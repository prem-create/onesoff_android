...
class VendorOnboardingController extends GetxController {
  ...
  void completeVendorSetup() {
    if (isShopOwner) {
      session.setRole('shop owner');
      Get.offAllNamed(AppRoutes.shopOwner);
      log("Shop Owner open module 4");
    } else {
      session.setRole('admin as vendor');
      Get.offAllNamed(AppRoutes.adminAsVendor);
      log("admin as vendor open module 5");
    }
  }
