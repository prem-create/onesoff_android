...
class AdminAsVendorTab extends StatefulWidget {
  const AdminAsVendorTab({super.key});

  @override
  State<AdminAsVendorTab> createState() => _AdminAsVendorTabState();
}

class _AdminAsVendorTabState extends State<AdminAsVendorTab> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text(AppStrings.adminAsVendorDashboardTitle)),
      body: Center(
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: DeviceResponsive.w(context, 24)),
          child: Text(
            AppStrings.adminAsVendorDashboardDescription,
